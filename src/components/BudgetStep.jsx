...
function BudgetStep({ 
  ...
  const totalAllocated = 
    ...
    const isOverBudget = totalAllocated > Number(budget);
  ...
  return (
    ...
    <div className="z-10 w-full max-w-2xl p-8 mx-4 bg-[#161920]/90 backdrop-blur-md border border-[#232836] rounded-2xl shadow-2xl transition-all duration-300">
      ...
      {/*  Categories Inputs Grid - Splits into 2 columns on desktop layout */}
      ...
      <div className="max-w-md mx-auto mt-8">
        <button
          onClick={nextStep}
          disabled={!budget || Number(budget) <= 0 || Number(budget) > Number(income) || isOverBudget}
